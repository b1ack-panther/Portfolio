	...
	return (
		<div id="contact" className="contact-container">
			<div className="heading">
				<h1 className="numbered-heading">Contact</h1>
			</div>
			<form 
				action="https://formsubmit.co/saurabh8604vns@gmail.com"
				method="POST"
			>
				<fieldset className="contact-outline">
					<p>Get in touch</p>
				...
				<div>
					<button type="submit">Hey there!</button>
				</div>
				</fieldset>
			</form>
